...
dir_path = '/projects/b1118/miniscope/analysis/spatial_data/spatial_clustering/jones_script_analysis/';
%session = 'DO_2_Day1_16_46_28';
save_path = strcat(dir_path, '50um_bins/moving_regions/' , erase(frameFileInput, '.csv') , '_');

%load csv file with frame subset to test
framesSubset = readtable(strcat(dir_path, frameFileInput), 'ReadVariableNames', true); 
